...
export const briefing = {
  edition: "盘后总结",
  updatedAt: "2026-09-22 08:30 CST",
  nextUpdate: "2026-09-23 08:30 CST",
  stance: "中性 · 科技反弹后观察利率与市场广度",
  score: 55,
  windowDates: { previous: "周五 · 09/18", today: "周一 · 09/22", future: "09/23—09/29" },
  headline: "科技反弹延续但市场广度有限，利率路径与宏观数据将决定其可持续性",
  summary:
    "09/18 美股常规时段已收盘：SPY 收于 $761.69，VOO 收于 $701.78，QQQ 收于 $721.45；三者均以当日可审计收盘记录为准。QQQ 相对开盘上涨 0.63%，科技继续强于宽基，但不应将开盘—收盘变化冒充收盘对收盘涨幅。跨资产中未能同源核对的日线继续明确留空。未来一周重点是利率曲线、美元及宏观数据是否支持这轮反弹扩散。",
  inference:
...
export const markets = [
  { name: "SPY", close: "$761.69", day: "暂无可信基准", week: "暂无可信基准", month: "暂无可信基准", summary: "震荡收稳", tone: "neutral", session: "09/18 美股常规时段收盘；未取得同源多周期历史序列", checkedAt: "09/22 08:30 CST", source: "https://exa.ai/library/markets/stock/SPY?date=2026-09-18", sourceLabel: "Exa Markets · 09/18 可审计收盘记录" },
  { name: "QQQ", close: "$721.45", day: "暂无可信基准", week: "暂无可信基准", month: "暂无可信基准", summary: "科技续强", tone: "up", session: "09/18 美股常规时段收盘；未取得同源多周期历史序列", checkedAt: "09/22 08:30 CST", source: "https://tradesmith.com/stockdata/QQQ:NASDAQ/historical-data", sourceLabel: "TradeSmith · QQQ 历史日线" },
  { name: "VOO", close: "$701.78", day: "暂无可信基准", week: "暂无可信基准", month: "暂无可信基准", summary: "窄幅收高", tone: "up", session: "09/18 美股常规时段收盘；未取得同源多周期历史序列", checkedAt: "09/22 08:30 CST", source: "https://exa.ai/library/markets/stock/VOO?date=2026-09-18", sourceLabel: "Exa Markets · 09/18 可审计收盘记录" },
