...
export const briefing = {
  edition: "盘后总结",
  updatedAt: "2026-08-11 08:30 CST",
  nextUpdate: "2026-08-12 08:30 CST",
  stance: "中性偏谨慎 · CPI 前防范油价再通胀",
  score: 54,
  windowDates: { previous: "周一 · 08/10", today: "周二 · 08/11", future: "08/12—08/18" },
  headline: "油价与长债收益率反弹压住风险偏好，CPI 成为本周第一道闸门",
  summary:
    "08/10 美股常规时段已收盘：SPY 跌 0.03%、QQQ 跌 0.30%，指数层面是温和回撤；但 10 年期美债官方日值上行 7bp 至 4.72%，2 年期升 6bp 至 4.25%，NYMEX WTI 9 月合约收于 $82.14、较上日高 5.07%。这表明市场重新计入能源对通胀和联储路径的尾部风险，而不是单纯延续弱就业后的估值扩张。本周的排序很清晰：先看 08/12 CPI，再看 PPI、零售销售和 SanDisk 投资者日；若油价和核心通胀同时偏强，高久期科技的估值压力会先于基本面变化反映出来。",
  inference:
    "市场判断基于公开资料的编辑性推断，不构成投资建议；事实、模型判断与数据缺口分开标注，所有时间已换算为北京时间。ETF 使用 08/10 美股常规时段收盘；10Y 使用 U.S. Treasury 08/10 官方日值；BTC 与 VOO 的 08/10 日线在可审计来源间未取得一致最终值，按规则显示暂无可信数据。",
};

export const markets = [
  { name: "SPY", close: "$773.03", day: "−0.03%", week: "+2.03%", month: "+2.39%", summary: "高位小幅回落", tone: "down", session: "08/10 美股常规时段收盘", checkedAt: "08/11 08:30 CST", source: "https://finance.yahoo.com/quote/SPY/history/", sourceLabel: "Yahoo Finance · SPY 同源历史收盘" },
  { name: "QQQ", close: "$720.87", day: "−0.30%", week: "+2.97%", month: "−0.64%", summary: "科技股承压", tone: "down", session: "08/10 美股常规时段收盘", checkedAt: "08/11 08:30 CST", source: "https://finance.yahoo.com/quote/QQQ/history/", sourceLabel: "Yahoo Finance · QQQ 同源历史收盘" },
  { name: "VOO", close: "暂无可信数据", day: "—", week: "—", month: "—", summary: "最终收盘待核", tone: "neutral", session: "08/10 多个公开历史页最终值不一致，未采用", checkedAt: "08/11 08:30 CST", source: "https://finance.yahoo.com/quote/VOO/history/", sourceLabel: "Yahoo Finance / FT · 08/10 最终值待一致核验" },
  { name: "10Y 美债", close: "4.72%", day: "+7bp", week: "+2bp", month: "+16bp", summary: "能源风险推高长端", tone: "up", session: "08/10 Treasury 官方日值；2Y 4.25%", checkedAt: "08/11 08:30 CST", source: "https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?field_tdr_date_value=2026&type=daily_treasury_yield_curve", sourceLabel: "U.S. Treasury · 官方同源日值" },
  { name: "DXY", close: "99.70", day: "+0.16%", week: "−0.20%", month: "−1.24%", summary: "油价带动反弹", tone: "up", session: "08/10 美元现货指数日线收盘", checkedAt: "08/11 08:30 CST", source: "https://www.investing.com/indices/usdollar-historical-data", sourceLabel: "Investing.com · DXY 同源日线", contextSource: "https://www.fx678.com/" },
  { name: "现货黄金", close: "$4,382.13", day: "+1.13%", week: "+8.11%", month: "+6.33%", summary: "避险与通胀共振", tone: "up", session: "08/10 XAU/USD 日线收盘", checkedAt: "08/11 08:30 CST", source: "https://www.investing.com/currencies/xau-usd-historical-data", sourceLabel: "Investing.com · XAU/USD 同源日线", contextSource: "https://www.fx678.com/" },
  { name: "WTI", close: "$82.14", day: "+5.07%", week: "+2.24%", month: "+15.03%", summary: "地缘溢价急升", tone: "up", session: "08/10 NYMEX WTI 9 月近月期货收盘", checkedAt: "08/11 08:30 CST", source: "https://finance.yahoo.com/quote/CL%3DF/history/", sourceLabel: "Yahoo Finance · CL=F 同源日线（近月期货，非现货）", contextSource: "https://www.fx678.com/" },
  { name: "BTC", close: "暂无可信数据", day: "—", week: "—", month: "—", summary: "日线口径待核", tone: "neutral", session: "08/10 可审计来源的日线收盘口径不一致或未最终化", checkedAt: "08/11 08:30 CST", source: "https://www.coingecko.com/en/coins/bitcoin/historical_data", sourceLabel: "CoinGecko · 08/10 close 未最终化" },
] as const;

export const events = [
  { window: "previous" as EventWindow, time: "收盘", category: "市场", impact: "高", title: "油价与收益率上行，宽基 ETF 温和收低", detail: "08/10 美股常规时段，SPY 收于 $773.03（−0.03%），QQQ 收于 $720.87（−0.30%）。指数跌幅有限，但 WTI 9 月近月期货升 5.07%，市场重新计入能源对通胀和估值的尾部风险。", source: "https://finance.yahoo.com/quote/SPY/history/", sourceLabel: "Yahoo Finance · ETF historical close" },
  { window: "previous" as EventWindow, time: "收盘", category: "利率", impact: "高", title: "10Y 美债官方日值升至 4.72%，2Y 升至 4.25%", detail: "美国财政部曲线显示，10Y 较 08/07 上升 7bp、2Y 上升 6bp。长端重定价会提高高估值科技股对本周 CPI 的敏感度；这是基于官方日值的事实，具体驱动仍需等待更多交易数据验证。", source: "https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?field_tdr_date_value=2026&type=daily_treasury_yield_curve", sourceLabel: "U.S. Treasury · official daily curve" },
  ...
  { window: "today" as EventWindow, time: "21:30", category: "开盘", impact: "高", title: "今晚美股开盘检验油价—收益率重定价是否扩散", detail: "若油价与长端收益率继续上行而 QQQ 继续弱于 SPY，通胀折现率将成为主线；若两者回落且科技相对走强，说明市场仍把弱就业视为更重要的信号。这是情景推演，不是对开盘方向的预测。", source: "https://www.nyse.com/markets/hours-calendars", sourceLabel: "NYSE hours · 编辑性影响路径" },
...
export const internationalNews = [
  { category: "中东 / 能源与航运", date: "08/10", impact: "WTI、通胀预期、美债与成长股估值", title: "NYMEX WTI 9 月近月期货单日升 5.07%，能源溢价重新进入资产定价", detail: "CL=F 的 08/10 收盘为 $82.14，较前一交易日上涨 5.07%。这是近月期货而非现货报价；若涨势延续，传导路径将是能源成本与通胀预期上升、长端收益率走高，再压缩高久期资产估值。后续观察实际船流、库存与 CPI 能源分项。", source: "https://finance.yahoo.com/quote/CL%3DF/history/", sourceLabel: "Yahoo Finance · NYMEX WTI near-month history" },
  { category: "美国利率 / 全球资产", date: "08/10", impact: "美债、美元、黄金与高久期股票", title: "10Y 美债官方日值单日升 7bp，CPI 前折现率风险抬升", detail: "财政部官方曲线显示 10Y 从 4.65% 升至 4.72%，2Y 从 4.19% 升至 4.25%。事实是收益率上行；将其完全归因于单一新闻并不严谨。模型层面，这会使本周 CPI 对科技股和黄金的价格影响更大。", source: "https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?field_tdr_date_value=2026&type=daily_treasury_yield_curve", sourceLabel: "U.S. Treasury · official daily curve" },
...
export const fedPolicy = {
  ...
  checkedAt: "08/11 08:30 CST",
  nextMeeting: "09/15—09/16（含经济预测）",
  summary: "7 月非农减少 2.3 万且前两月合计下修 10.3 万，使继续加息门槛显著上升；工资同比放缓至 3.2%也削弱工资通胀压力。但 08/10 WTI 近月期货大涨、10Y 官方日值升至 4.72%，重新抬高通胀尾部风险。模型基准仍是按兵不动，而非政策承诺；CPI、PPI 与零售销售将检验弱就业能否抵消能源和服务价格压力。",
  drivers: [
...
export const signals = {
  options: [{ ticker: "本期", text: "截至 08/11 08:30，未取得覆盖全部关注标的、带历史基准且可审计的完整期权逐笔数据；不把新闻摘要、单笔成交量或社交媒体截图定义为期权异动。" }],
...
export const sources = [
  ...
  ["Yahoo Finance · SPY historical close", "https://finance.yahoo.com/quote/SPY/history/"],
  ["Yahoo Finance · QQQ historical close", "https://finance.yahoo.com/quote/QQQ/history/"],
  ["Yahoo Finance · NYMEX WTI near-month historical close", "https://finance.yahoo.com/quote/CL%3DF/history/"],
