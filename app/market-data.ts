...
export const markets = [
  { name: "SPY", close: "$770.56", day: "−0.32%", week: "−0.10%", month: "+2.07%", summary: "冲高回落收低", tone: "down", session: "08/11 美股常规时段收盘；一周/一月基准为 08/04、07/10", checkedAt: "08/12 08:30 CST", source: "https://query2.finance.yahoo.com/v8/finance/chart/SPY?period1=1783555200&period2=1786665600&interval=1d", sourceLabel: "Yahoo Finance Chart API · SPY 同源日线" },
  { name: "QQQ", close: "$718.45", day: "−0.34%", week: "−0.75%", month: "−0.97%", summary: "科技延续回撤", tone: "down", session: "08/11 美股常规时段收盘；一周/一月基准为 08/04、07/10", checkedAt: "08/12 08:30 CST", source: "https://query2.finance.yahoo.com/v8/finance/chart/QQQ?period1=1783555200&period2=1786665600&interval=1d", sourceLabel: "Yahoo Finance Chart API · QQQ 同源日线" },
  { name: "VOO", close: "$708.42", day: "−0.31%", week: "−0.08%", month: "+2.10%", summary: "随大盘小幅回落", tone: "down", session: "08/11 美股常规时段收盘；一周/一月基准为 08/04、07/10", checkedAt: "08/12 08:30 CST", source: "https://query2.finance.yahoo.com/v8/finance/chart/VOO?period1=1783555200&period2=1786665600&interval=1d", sourceLabel: "Yahoo Finance Chart API · VOO 同源日线" },
  ...
  { name: "DXY", close: "99.82", day: "+0.01%", week: "−0.07%", month: "−1.14%", summary: "窄幅震荡偏弱", tone: "down", session: "08/11 ICE 美元指数日线；一周/一月基准为 08/04、07/10", checkedAt: "08/12 08:30 CST", source: "https://query2.finance.yahoo.com/v8/finance/chart/DX-Y.NYB?period1=1783555200&period2=1786665600&interval=1d", sourceLabel: "Yahoo Finance Chart API · DXY 同源日线", contextSource: "https://www.fx678.com/" },
  { name: "现货黄金", close: "$4,380.25", day: "−0.49%", week: "+7.57%", month: "+6.62%", summary: "高位获利回吐", tone: "down", session: "08/11 XAU/USD UTC 日线；一周/一月基准为 08/04、07/10", checkedAt: "08/12 08:30 CST", source: "https://chartexchange.com/symbol/forex-xauusd/historical/", sourceLabel: "ChartExchange · XAU/USD 同源 UTC 日线", contextSource: "https://www.fx678.com/" },
  { name: "WTI", close: "$83.43", day: "+1.58%", week: "+10.11%", month: "+16.83%", summary: "地缘溢价续升", tone: "up", session: "08/11 NYMEX WTI 近月期货收盘；一周/一月基准为 08/04、07/10", checkedAt: "08/12 08:30 CST", source: "https://www.investing.com/commodities/crude-oil-historical-data", sourceLabel: "Investing.com · WTI near-month futures（非现货）", contextSource: "https://www.fx678.com/" },
  { name: "BTC", close: "$63,612", day: "−0.53%", week: "−0.80%", month: "−0.80%", summary: "震荡走弱", tone: "down", session: "08/11—08/12 UTC 日线收盘；一周基准 08/04，月度 07/10", checkedAt: "08/12 08:30 CST", source: "https://coincodex.com/crypto/bitcoin/historical-data/", sourceLabel: "CoinCodex UTC 日线；月度交叉核对 Yahoo Finance", contextSource: "https://finance.yahoo.com/quote/BTC-USD/history/" },
] as const;
